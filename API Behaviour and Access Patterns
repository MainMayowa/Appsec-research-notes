...
### Testing Note
Direct navigation to an endpoint in the browser may not accurately reflect how the application uses it internally.
Authenticated API behavior is often better understood by observing real application requests and replaying them with the same session context.
